...
mkdir experiments/annealing_experiments/wave/results
mkdir experiments/annealing_experiments/wave/results/tmp
python training.py experiments/annealing_experiments/wave/ $1
python evaluation.py experiments/annealing_experiments/wave/ $1
